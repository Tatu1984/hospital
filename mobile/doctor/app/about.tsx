      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
        <View className="bg-white rounded-2xl p-5 items-center">
          <View className="w-16 h-16 rounded-2xl bg-teal-50 items-center justify-center">
            <Stethoscope color="#14b8a6" size={28} />
          </View>
          <Text className="mt-3 text-xl font-bold text-slate-900">HospitalPro Doctor</Text>
          <Text className="text-xs text-slate-500 mt-1">Clinical companion app</Text>
