    ...
    <div className="p-6 lg:p-8 space-y-6 min-h-full max-w-[1500px] mx-auto">
      <div className="flex justify-between items-center flex-wrap gap-3">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Inpatient Department</h1>
            <p className="text-sm text-slate-500 mt-0.5">Ward management, admissions, and patient care</p>
          </div>
        </div>
        ...
        <Card className="rounded-2xl">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div className="text-xs uppercase tracking-wide text-slate-500 font-medium">Total beds</div>
            ...
            <div className="text-3xl font-semibold text-slate-900 mt-2 tracking-tight tabular-nums">{stats.totalBeds}</div>
          </CardContent>
        </Card>
        <Card className="rounded-2xl">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div className="text-xs uppercase tracking-wide text-slate-500 font-medium">Occupied</div>
            ...
            <div className="text-3xl font-semibold text-orange-700 mt-2 tracking-tight tabular-nums">{stats.occupied}</div>
            <div className="text-[11px] text-slate-500 mt-1">{stats.totalBeds ? `${Math.round((stats.occupied / stats.totalBeds) * 100)}% utilisation` : '—'}</div>
          </CardContent>
        </Card>
        <Card className="rounded-2xl">
          <CardContent className="p-5">
            ...
            <div className="text-3xl font-semibold text-emerald-700 mt-2 tracking-tight tabular-nums">{stats.available}</div>
          </CardContent>
        </Card>
        <button
          onClick={() => setIsActiveAdmissionsOpen(true)}
          title="Click to see all active admissions and assign beds"
          className="text-left rounded-2xl border border-slate-200/70 bg-white shadow-[0_1px_2px_rgb(0_0_0_/_0.04)] hover:border-slate-300 hover:shadow-sm transition-all p-5"
        >
          <div className="flex items-center justify-between">
            <div className="text-xs uppercase tracking-wide text-slate-500 font-medium">Active admissions</div>
            <div className="w-8 h-8 rounded-lg bg-blue-50 ring-1 ring-blue-100 flex items-center justify-center">
              <ArrowLeftRight className="w-4 h-4 text-blue-600" />
            </div>
          </div>
          <div className="text-3xl font-semibold text-blue-700 mt-2 tracking-tight tabular-nums">{stats.activeAdmissions}</div>
          <div className="text-[11px] text-slate-500 mt-1">Click to view list →</div>
        </button>
      </div>
