    ...
    <div className="p-6 lg:p-8 space-y-6 min-h-full max-w-[1500px] mx-auto">
      <div className="flex justify-between items-center flex-wrap gap-3">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-slate-900 tracking-tight">Pharmacy Management System</h1>
            <p className="text-sm text-slate-500 mt-0.5">Complete drug inventory, stock management, and POS billing</p>
          </div>
        </div>
      </div>
        ...
        <Card className="rounded-2xl">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div className="text-xs uppercase tracking-wide text-slate-500 font-medium">Total Drugs</div>
              <div className="w-8 h-8 rounded-lg bg-teal-50 ring-1 ring-teal-100 flex items-center justify-center">
                <Pill className="w-4 h-4 text-teal-600" />
              </div>
            </div>
            <div className="text-3xl font-semibold text-slate-900 mt-2 tracking-tight tabular-nums">{stats.totalDrugs}</div>
          </CardContent>
        </Card>
        <Card className="rounded-2xl">
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div className="text-xs uppercase tracking-wide text-slate-500 font-medium">Today's Sales</div>
              <div className="w-8 h-8 rounded-lg bg-green-50 ring-1 ring-green-100 flex items-center justify-center">
                <TrendingUp className="w-4 h-4 text-green-600" />
              </div>
            </div>
            <div className="text-3xl font-semibold text-green-700 mt-2 tracking-tight tabular-nums">{stats.todaySales}</div>
          </CardContent>
        </Card>
        <Card className="rounded-2xl">
          <CardContent className="p-5">
