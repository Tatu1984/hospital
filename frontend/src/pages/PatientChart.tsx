  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
        ...
        <CountCard icon={Scan} tint="bg-purple-500" label="Imaging" value={radOrders.length} />
        <CountCard icon={Pill} tint="bg-pink-500" label="Prescriptions" value={data.prescriptions.length} />
