// ===========================
// FIXED ICU & CRITICAL CARE APIs
// Replace the existing ICU endpoints in server.ts with these
// ===========================

// GET /api/icu/beds - Get all ICU beds with patient info and latest vitals
      ...
      return {
        ...
        latestVitals: bed.vitalsRecords[0] ? {
          ...
          bp: bed.vitalsRecords[0].systolicBP && bed.vitalsRecords[0].diastolicBP
            ? `${bed.vitalsRecords[0].systolicBP}/${bed.vitalsRecords[0].diastolicBP}` : null,
...
// POST /api/icu/vitals - Record vital signs with critical alert checking
...
// POST /api/icu/ventilator - Update ventilator settings
...
// GET /api/icu/alerts - Get critical alerts
